...
export class KeycloakUserService {
    public static async loginSSO({oauthUri, correo, contrasenia}: {oauthUri: string, esperaRedireccion?: boolean, correo: string, contrasenia: string}): Promise<[AxiosResponse, Cookie[]]> {
